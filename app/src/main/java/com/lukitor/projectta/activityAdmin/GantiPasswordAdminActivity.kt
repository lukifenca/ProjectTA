...
import com.lukitor.projectta.databinding.ActivityGantiPasswordAdminBinding
import com.lukitor.projectta.databinding.ActivityGantiPasswordPasienBinding

class GantiPasswordAdminActivity : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    lateinit var binding: ActivityGantiPasswordAdminBinding
    private lateinit var user: FirebaseUser
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityGantiPasswordAdminBinding.inflate(layoutInflater)
