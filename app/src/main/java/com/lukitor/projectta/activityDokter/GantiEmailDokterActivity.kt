...
class GantiEmailDokterActivity : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    lateinit var binding: ActivityGantiEmailDokterBinding
    private lateinit var user: FirebaseUser
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityGantiEmailDokterBinding.inflate(layoutInflater)
                ...
                user.let {
                    user.updateEmail(email).addOnCompleteListener {
                        if (it.isSuccessful) {
                            Toast.makeText(
                                this,
                                "Email Berhasil Ganti, Email telah di ganti dengan : " + email,
                                Toast.LENGTH_SHORT
                            ).show()
